...
This mirry supports flavoring via environment variables passed to `flutter build/run` commands.
...
import 'package:mirry/src/modules/bloc_screen/view/bloc_view.dart';
export 'package:mirry/src/modules/bloc_screen/view/bloc_view.dart';
...
Perform this checklist: [mirry using checklist](doc/mirry-start-checklist.md).
